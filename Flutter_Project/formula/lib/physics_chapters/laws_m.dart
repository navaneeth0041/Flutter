...
class LawsMPage extends StatefulWidget {
  @override
  // ignore: library_private_types_in_public_api
  _LawsMPageState createState() => _LawsMPageState();
}

class _LawsMPageState extends State<LawsMPage> with TickerProviderStateMixin {
  List<String> asset = [
    'assets/img/lm1.png',
    'assets/img/lm2.png',
    'assets/img/lm3.png',
