...
class HiddenDrawerMS extends StatefulWidget {
  const HiddenDrawerMS({super.key});

  @override
  State<HiddenDrawerMS> createState() => _HiddenDrawerMState();
}

class _HiddenDrawerMState extends State<HiddenDrawerMS> {
