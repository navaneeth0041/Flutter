...
class StructureAPage extends StatefulWidget {
  @override
  // ignore: library_private_types_in_public_api
  _StructureAPageState createState() => _StructureAPageState();
}

class _StructureAPageState extends State<StructureAPage> with TickerProviderStateMixin {
  List<String> asset = [
    'assets/img/sa1.png',
    'assets/img/sa2.png',
    'assets/img/sa3.png',
